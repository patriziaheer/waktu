...
public class TestTimeUtil extends TestSuite {
    ...
    public void getFirstDayOfWeek_Monday() {
        ...
        assertEquals(refFirstDayOfWeek,
                TimeUtil.getFirstDayOfWeek(new QDate(2011, 5, 9)));
    }
    ...
    public void getFirstDayOfWeek_Saturday() {
        QDate refFirstDayOfWeek = new QDate(2011, 5, 9);
        assertEquals(refFirstDayOfWeek,
                TimeUtil.getFirstDayOfWeek(new QDate(2011, 5, 14)));
    }
    ...
    public void getFirstDayOfWeek_Sunday() {
        QDate refFirstDayOfWeek = new QDate(2011, 5, 9);
        assertEquals(refFirstDayOfWeek,
                TimeUtil.getFirstDayOfWeek(new QDate(2011, 5, 15)));
    }
    ...
    public void getFirstDayOfWeek_WeekSpanningOverFebruaryMarchLeapyear() {
        ...
        assertEquals(refFirstDayOfWeek,
                TimeUtil.getFirstDayOfWeek(new QDate(2008, 3, 2)));
    }

    public void getWeekBoundaries() {
        QDate[] refStartDateEndDate = {new QDate(2011, 5, 9),
                new QDate(2011, 5, 15) };
        assertBoundaryEquality(refStartDateEndDate,
                TimeUtil.getWeekBoundaries(new QDate(2011, 5, 13)));
    }

    @Test
    public void getWeekBoundaries_WeekSpanningOverTwoMonths() {
        QDate[] refStartDateEndDate = {new QDate(2011, 5, 30),
                new QDate(2011, 6, 5) };
        assertBoundaryEquality(refStartDateEndDate,
                TimeUtil.getWeekBoundaries(new QDate(2011, 5, 31)));
    }

    @Test
    public void getWeekBoundaries_WeekSpanningOverFebruaryMarchLeapyear() {
        QDate[] refStartDateEndDate = {new QDate(2008, 2, 25),
                new QDate(2008, 3, 2) };
        assertBoundaryEquality(refStartDateEndDate,
                TimeUtil.getWeekBoundaries(new QDate(2008, 3, 1)));
    }
