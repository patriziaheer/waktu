...
public class TestProjectController extends TestSuiteDataController {
    ...
    public static void before() {
        ...
        try {
            ...
            Project p1 = pc.addProject("0001-SBB", "SBB Verwaltungssoftware",
                    usr2, 125);
            Project p2 = pc.addProject("0002-HSR", "Stundenplansoftware", usr1,
                    130);
            Project p3 = pc.addProject("0003-UNIZH", "Stundenplansoftware",
                    usr1, 543);
