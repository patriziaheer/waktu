...
public class Ui_ProjectWorkSessions implements
    ...
    public void setupUi(QWidget ProjectWorkSessions) {
        ...
        sizePolicy1.setHeightForWidth(cmbWorkpackage.sizePolicy()
                .hasHeightForWidth());
        ...
        sizePolicy6.setHeightForWidth(chkFilterDate.sizePolicy()
                .hasHeightForWidth());
        ...
        sizePolicy7.setHeightForWidth(btnAddFilter.sizePolicy()
                .hasHeightForWidth());
        ...
        sizePolicy8.setHeightForWidth(btnRemoveFilter.sizePolicy()
                .hasHeightForWidth());
    ...
    void retranslateUi(QWidget ProjectWorkSessions) {
        ProjectWorkSessions
                .setWindowTitle(com.trolltech.qt.core.QCoreApplication
                        .translate("ProjectWorkSessions", "WorkSessions", null));
        txtStart.setDisplayFormat(com.trolltech.qt.core.QCoreApplication
                .translate("ProjectWorkSessions", "dd.MM.yy", null));
        lblBis.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "ProjectWorkSessions", "-", null));
        txtEnd.setDisplayFormat(com.trolltech.qt.core.QCoreApplication
                .translate("ProjectWorkSessions", "dd.MM.yy", null));
        chkFilterDate.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "ProjectWorkSessions", "Datefilter", null));
        btnAddFilter.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "ProjectWorkSessions", "Add Filter", null));
        btnRemoveFilter.setText(com.trolltech.qt.core.QCoreApplication
                .translate("ProjectWorkSessions", "Remove Filter", null));
        lblTotalTimeText.setText(com.trolltech.qt.core.QCoreApplication
                .translate("ProjectWorkSessions", "Total Time:", null));
        lblTotalTime.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "ProjectWorkSessions", "0.0h", null));
    } // retranslateUi
