...
public class Ui_ProjectStaff implements com.trolltech.qt.QUiForm<QWidget> {
    ...
    public Ui_ProjectStaff() {
        super();
    }

    public void setupUi(QWidget ProjectStaff) {
        ProjectStaff.setObjectName("ProjectStaff");
        ProjectStaff.resize(new QSize(700, 360).expandedTo(ProjectStaff
                .minimumSizeHint()));
        ...
        sizePolicy.setHeightForWidth(ProjectStaff.sizePolicy()
                .hasHeightForWidth());
        ProjectStaff.setSizePolicy(sizePolicy);
        ProjectStaff.setMinimumSize(new QSize(700, 360));
    ...
    void retranslateUi(QWidget ProjectStaff) {
        ProjectStaff.setWindowTitle(com.trolltech.qt.core.QCoreApplication
                .translate("ProjectStaff", "WorkPackage", null));
        btnAdd.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "ProjectStaff", "Add", null));
    } // retranslateUi
