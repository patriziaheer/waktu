...
public class Ui_Calendar implements com.trolltech.qt.QUiForm<QWidget> {
    ...
    public void setupUi(QWidget Calendar) {
        ...
        Calendar.resize(new QSize(649, 100).expandedTo(Calendar
                .minimumSizeHint()));
        ...
        QSizePolicy sizePolicy6 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        ...
        QSizePolicy sizePolicy7 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        ...
        lblBis.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag
        ...
        QSizePolicy sizePolicy8 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy8.setHorizontalStretch((byte) 0);
        sizePolicy8.setVerticalStretch((byte) 0);
        sizePolicy8
                .setHeightForWidth(btnRight.sizePolicy().hasHeightForWidth());
        ...
        QSizePolicy sizePolicy9 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        ...
        lblStart.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag
                .createQFlags(
        ...
        QSizePolicy sizePolicy10 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy10.setHorizontalStretch((byte) 0);
        sizePolicy10.setVerticalStretch((byte) 0);
        sizePolicy10.setHeightForWidth(lblCurrDate.sizePolicy()
                .hasHeightForWidth());
        ...
        QSizePolicy sizePolicy11 = new QSizePolicy(
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed,
                com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy11.setHorizontalStretch((byte) 0);
        sizePolicy11.setVerticalStretch((byte) 0);
        sizePolicy11.setHeightForWidth(btnToday.sizePolicy()
                .hasHeightForWidth());
        ...
        lblLogo.setPixmap(new QPixmap(
                ("../../../../../../../resources/icons/logo_klein.png")));
    ...
    void retranslateUi(QWidget Calendar) {
        Calendar.setWindowTitle(com.trolltech.qt.core.QCoreApplication
                .translate("Calendar", "Form", null));
        btnMo.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Mon", null));
        btnMi.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Wed", null));
        btnFri.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Fri", null));
        btnSo.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Sun", null));
        btnSa.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Sat", null));
        btnDo.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Thu", null));
        btnDi.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Tue", null));
        lblBis.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "-", null));
        btnRight.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", ">", null));
        btnLeft.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "<", null));
        lblEnd.setText("");
        lblStart.setText("");
        lblCurrDate.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "23.05.11", null));
        btnToday.setText(com.trolltech.qt.core.QCoreApplication.translate(
                "Calendar", "Today", null));
        lblLogo.setText("");
    } // retranslateUi
